...
const topReferralRoutes = require('./routes/topReferrals.cjs');
...
const vpnServerRoutes = require('./routes/vpnServers.cjs');
const promotionRoutes = require('./routes/promotion.cjs');
...
app.use('/api', topReferralRoutes);
app.use('/api', channelRoutes);
app.use('/api', botRoutes);
app.use('/api', vpnRoutes);
app.use('/api', vpnServerRoutes);
